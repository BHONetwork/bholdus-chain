...
parameter_types! {
    pub const PrecompilesValue: PalletExamplePrecompileSet<Runtime> =
    PalletExamplePrecompileSet(PhantomData);
}
...
impl pallet_evm::Config for Runtime {
    ...
    type PrecompilesType = PalletExamplePrecompileSet<Self>;
