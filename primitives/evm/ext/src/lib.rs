...
pub trait BholdusExt {
	...
	/// An `Evm` event proxied by the Bholdus runtime to this host function.
	/// evm -> bholdus_runtime -> host.
	...
	/// A `Gasometer` event proxied by the Bholdus runtime to this host function.
	/// evm_gasometer -> bholdus_runtime -> host.
	...
	/// A `Runtime` event proxied by the Bholdus runtime to this host function.
	/// evm_runtime -> bholdus_runtime -> host.
