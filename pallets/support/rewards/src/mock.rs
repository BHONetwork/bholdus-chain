//! Mocks for the bholdus rewards.

#![cfg(test)]

use super::*;
use frame_support::{
    construct_runtime, parameter_types, traits::Everything, weights::constants::RocksDbWeight,
};
use sp_core::H256;
...
construct_runtime!(
    ...
    UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        SupportReward: rewards::{Pallet, Storage, Call},
    }
);
