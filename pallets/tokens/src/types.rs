...
pub struct AssetIdentity {
	...
	//    /// A reasonable display name for the controller of the account. This could be whatever
	// it is    /// that it is typically known as and should not be confusable with other entities,
	// given    /// reasonable context.
	//    ///
	//    /// Stored as UTF-8.
	...
	for Registration<Balance>
{
	fn decode<I: codec::Input>(input: &mut I) -> sp_std::result::Result<Self, codec::Error> {
		...
		Ok(Self { deposit, info, is_verifiable })
	}
}
