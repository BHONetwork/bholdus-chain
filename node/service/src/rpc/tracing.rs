...
use bholdus_evm_rpc_debug::DebugHandler;
use bholdus_evm_rpc_debug::{Debug, DebugRequester, DebugServer};
use bholdus_evm_rpc_trace::{
...
// Spawn the tasks that are required to run a Bholdus tracing node.
...
where
    ...
    C: Send + Sync + 'static,
    C::Api: EthereumRuntimeRPCApi<B> + bholdus_evm_rpc_primitives_debug::DebugRuntimeApi<B>,
