...
pub mod currency {
    ...
    pub const TOKEN_SYMBOL: &str = "BHOT";
...
/// Time.
pub mod time {
    use bholdus_primitives::{BlockNumber, Moment};
...
pub mod fee {
    ...
    impl WeightToFeePolynomial for WeightToFee {
        ...
        fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
            ...
            let p = super::currency::UNITS / 1000;
...
mod tests {
    ...
    fn full_block_fee_is_correct() {
        ...
        println!("Weight fee: {}", x);
        let y = 8 * DOLLARS;
        assert!(x.max(y) - x.min(y) < super::currency::UNITS / 1000);
    }
    ...
    fn extrinsic_base_fee_is_correct() {
        ...
        println!("Weight fee: {}", x);
        let y = super::currency::UNITS / 1000;
        assert!(x.max(y) - x.min(y) < super::currency::UNITS / 1000);
    }
}
