...
/// The PrecompileSet installed in the Ulas runtime.
/// We include the nine Istanbul precompiles
/// (https://github.com/ethereum/go-ethereum/blob/3c46f557/core/vm/contracts.go#L69)
/// as well as a special precompile for dispatching Substrate extrinsics
#[derive(Debug, Clone, Copy)]
pub struct UlasPrecompiles<R>(PhantomData<R>);

impl<R> UlasPrecompiles<R>
where
    R: pallet_evm::Config,
{
    pub fn new() -> Self {
...
/// 1024-2047 Precompiles that are not in Ethereum Mainnet but are neither Ulas specific
/// 2048-4095 Ulas specific precompiles
impl<R> PrecompileSet for UlasPrecompiles<R>
where
    ...
    R: pallet_evm::Config,
{
    fn execute(
        ...
        match address {
            ...
            // Non-Ulas specific nor Ethereum precompiles :
            a if a == hash(1024) => {
